...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [65871.300422, 6317376.378786, 261266.533997, 6458781.440160], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([65871.300422, 6317376.378786, 261266.533997, 6458781.440160], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">OTTEC - Environnement & biodiversité</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (750 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Application créée dans le cadre de l\'Observatoire Territorial de la Transition Ecologique et Climatique.<br /><br />Pour masquer la légende, cliquez sur l\'icône en forme de chevrons au-dessus de celle-ci. Pour visualiser à nouveau la légende, cliquez sur l\'icône représentant un carré de couleur bleue. Cochez ou décochez ensuite l\'affichage des éléments que vous souhaitez ajouter ou retirer à la carte. Vous pouvez également cliquer directement sur les éléments à l\'intérieur de la carte pour afficher une info-bulle descriptive.<br /><br />N.B. : certains éléments ne sont visibles qu\'à partir d\'un certain niveau de zoom. Il est aussi déconseillé d\'activer un trop grand nombre d\'éléments en même temps.<br /><br />Pôle d\'Equilibre Territorial et Rural du Pays de Bray (2025).';
            }
