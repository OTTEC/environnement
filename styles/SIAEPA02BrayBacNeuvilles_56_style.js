...
var style_SIAEPA02BrayBacNeuvilles_56 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var bufferColor = "#01fff7";
    var bufferWidth = 1.0;
    var textAlign = "left";
    var offsetX = 0;
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Operateur") !== null) {
        labelText = String(feature.get("Operateur"));
    }
