var size = 0;
var placement = 'point';
function categories_Altitude_80(feature, value, size, resolution, labelText,
...
var style_Altitude_80 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Altitude_80(feature, value, size, resolution, labelText,
